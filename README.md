...
The Automation Catalog supports **optional** Azure AD (Microsoft Entra ID) authentication to restrict access to your organization. Authentication is **pre-configured** in Azure Static Web Apps - no setup needed!
...
- ⚡ **Pre-configured authentication** - routes work automatically
- 🚀 No code changes required - uses Azure Static Web Apps built-in auth
- 🔑 Built-in authentication routes: `/.auth/login/aad` and `/.auth/logout`
- 🌐 Public by default - perfect for cloning and getting started quickly
- ✅ No Azure Portal setup, app registration, or client secrets needed

### Quick Start to Enable SSO (3 Steps!)

Authentication routes are **pre-configured and always available** on your site. To enable SSO:
...
3. **Test**: Visit your site - you'll be automatically redirected to Microsoft login
...
For detailed instructions, see **[docs/Enabling_SSO.md](docs/Enabling_SSO.md)**
